...
import { Container, BoxLoading, BoxForm, BoxTitleService, TitleService, TextTitle, Line, 
  BoxTextImage, TextImage, BoxAddImage, ContainerImage,
    ButtonAddImage, ImageAdd, BoxImages, 
      ImageService, BoxButtonSave, ButtonSave, BoxPositionDelete,BoxDelete, ImageDelete, BoxButtonTrash, ButtonTrash } from './styles';
...
const EditCompleteServices = () => {
  ...
  async function handleTrash() {
    ...
    Alert.alert(
      'Realmente deseja excluir o serviço?',
      'Lembre-se, ao excluir um serviço, clientes não encontraram você por este serviço',
      [
        {
          text: 'Não',
          onPress: () => {
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              const response = await api.delete(`serviceProvider?id=${idService}`);    
        ...
        {loading ? (
          ...
          <SafeAreaView>        
            <ScrollView style={{flex: 1, height: '100%'}}>
                ...
                <BoxButtonTrash>
                   <ButtonTrash loading={loadingTrash} onPress={handleTrash}>Excluir serviço</ButtonTrash>
                </BoxButtonTrash>                          
            </ScrollView>                   
        </SafeAreaView>
        )}
